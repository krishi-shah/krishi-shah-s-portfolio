...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 40px -10px hsla(238, 84%, 62%, 0.5)',
        'glow-lg': '0 0 60px -15px hsla(238, 84%, 62%, 0.6)',
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'radial-gradient(ellipse 80% 50% at 50% -20%, hsla(238, 84%, 62%, 0.15), transparent)',
        'hero-pattern-dark': 'radial-gradient(ellipse 80% 50% at 50% -20%, hsla(238, 84%, 62%, 0.25), transparent)',
